    ...
    <>
      ...
      <main className="flex flex-col space-y-16">
        ...
        <section>
          ...
          <SectionParagraph>
            No accounts, streaks, leaderboards, metrics or anything else to get
            in the way. It's ready for you to{' '}
            <Link href="/app">get started now</Link>. Your data is stored on
        ...
        <section>
          ...
          <SectionParagraph>
            The 14 horizontal dots represent a two week window into your
            progress. A solid dot represents a day where a habit has been
            completed, and the following days represent the cooldown based on
            the rhythm frequency.
          </SectionParagraph>
        </section>
        ...
        <section>
          ...
          <SectionParagraph>
            ...
            to track per rhythm. Each rhythm has a circle in a stripe, solid
            when it's completed and blurry when it isn't.
          </SectionParagraph>
